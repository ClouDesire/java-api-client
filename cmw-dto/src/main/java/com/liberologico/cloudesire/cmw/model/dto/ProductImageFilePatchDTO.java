...
public class ProductImageFilePatchDTO extends FileDTO
{
    ...
    public boolean equals( Object o )
    {
        ...
        if ( !( o instanceof ProductImageFilePatchDTO ) ) return false;
        if ( !super.equals( o ) ) return false;
        ProductImageFilePatchDTO that = (ProductImageFilePatchDTO) o;
