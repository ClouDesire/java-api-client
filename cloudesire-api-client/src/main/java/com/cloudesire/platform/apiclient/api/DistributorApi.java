...
import com.cloudesire.platform.apiclient.query.DistributorQuery;
...
public interface DistributorApi
{
    ...
    @GET( "distributor" )
    Call<List<DistributorDTO>> getAll( @QueryMap DistributorQuery query );

    /**
     * @deprecated by {@link #getAll(DistributorQuery)}
     */
