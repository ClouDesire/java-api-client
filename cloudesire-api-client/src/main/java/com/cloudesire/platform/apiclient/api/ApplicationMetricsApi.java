...
public interface ApplicationMetricsApi
{
    ...
    Call<ApplicationMetricDTO> get( @Path( "id" ) Integer id );

    @PUT( "applicationMetric/{id}" )
    Call<ApplicationMetricDTO> update( @Body ApplicationMetricDTO input, @Path( "id" ) Integer id );
}
